...
![Создание файла hello.asm](screenshots/1созданиефайла.png){#fig:fig1}

Создаем нужный каталог lab04/programs и затем создаем файл hello.asm (рис. [-
@fig:fig1])

![Редактирование](screenshots/2вставляемкод.png)
